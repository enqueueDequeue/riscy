...
class Execute()(implicit val params: Parameters) extends Module {
  ...
  val maskW0 = Fill(params.wordWidth, 0.U(1.W))
  val maskW1 = Fill(params.wordWidth, 1.U(1.W))

  val mask0 = Cat(maskW0, maskW1)
  val mask1 = Cat(maskW1, maskW0)

  val aWord = Mux(io.a(params.wordWidth - 1), io.a | mask1, io.a & mask0)
  val bWord = Mux(io.b(params.wordWidth - 1), io.b | mask1, io.b & mask0)
